...
import CallCenterJornadaConsolidada from '@/components/callcenter/CallCenterJornadaConsolidada';
...
export default function CallCenterJornadaPage() {
  ...
  const [jornadaRefreshKey, setJornadaRefreshKey] =
    useState(0);
  ...
  const buildRequest =
    (): CallCenterUltimaHoraRequest => ({
      ...
      ventanillaRegistroId:
        form.ventanillaRegistroId
          ? Number(form.ventanillaRegistroId)
          : null,
      ...
      barrioId:
        form.barrioId
          ? Number(form.barrioId)
          : null,

      funcionarioCallcenterId:
        Number(form.funcionarioCallcenterId),

      encuestadorId:
        Number(form.encuestadorId),
  ...
  return (
    <Stack spacing={3}>
              ...
              <Stack spacing={2.5}>
                ...
                >
                  <TextField
                    ...
                    select
                    value={form.funcionarioCallcenterId}
                    onChange={(event) =>
                      updateForm(
                        'funcionarioCallcenterId',
                        event.target.value,
            ...
            <Stack spacing={2}>
              ...
              >
                <ResultItem
                  ...
                  value={`#${result.registro.id}`}
                />

                <ResultItem
                  label="Ciudadano"
                  value={result.registro.nombreCompleto}
                />

                <ResultItem
                  label="Cédula"
                  value={result.registro.cedulaSolicitante}
                />
      ...
      <CallCenterJornadaConsolidada
        funcionarios={funcionarios}
        encuestadores={encuestadores}
        loadingCatalogs={loadingCatalogs}
        refreshKey={jornadaRefreshKey}
      />
